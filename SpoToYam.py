...
playlist = sp.playlist(config.spotify_playlist_id)
...
def check_created_playlist(playlists):
    global edited_playlist
    for playlist_item in playlists:
        if playlist_item['title'] == playlist_name:
...
if check_created_playlist(user_playlists):
